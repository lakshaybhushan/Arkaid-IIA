...
def load_mapping():
    ...
    mapping_path = 'dags/mappings/players_mappings.json'
...
# Create the DAG
dag = DAG(
    'materialized_view_players',
    default_args=default_args,
    description='Creates and refreshes materialized view for players',
    schedule_interval='@daily',
    catchup=False
)

logger.info("Creating DAG: materialized_view_players")
