...
def load_mapping():
    ...
    mapping_path = 'dags/mappings/modders_mappings.json'
...
# Create the DAG
dag = DAG(
    'materialized_view_modders',
    default_args=default_args,
    description='Creates and refreshes materialized view for modders',
    schedule_interval='@daily',
    catchup=False
)

logger.info("Creating DAG: materialized_view_modders")
