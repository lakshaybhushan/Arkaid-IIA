...
def load_mapping():
    ...
    mapping_path = 'dags/mappings/hardware_requirements_mappings.json'
...
# Create the DAG
dag = DAG(
    'materialized_view_hardware_requirements',
    default_args=default_args,
    description='Creates and refreshes materialized view for hardware requirements',
    schedule_interval='@daily',
    catchup=False
)

logger.info("Creating DAG: materialized_view_hardware_requirements")
